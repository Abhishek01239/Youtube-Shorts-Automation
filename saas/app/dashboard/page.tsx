...
export default async function Dashboard(){
 ...
 <div style={{display:"flex",gap:12,flexWrap:"wrap",margin:"24px 0"}}><a href="/api/auth/twitch" style={{padding:"12px 18px",borderRadius:10,background:"#9146ff",color:"#fff",textDecoration:"none"}}>{has("twitch")?"Reconnect Twitch":"Connect Twitch"}</a><a href="/api/auth/youtube" style={{padding:"12px 18px",borderRadius:10,background:"#ff0033",color:"#fff",textDecoration:"none"}}>{has("youtube")?"Reconnect YouTube":"Connect YouTube"}</a><a href="/api/billing/create" style={{padding:"12px 18px",borderRadius:10,background:"#ff6a00",color:"#fff",textDecoration:"none",fontWeight:800}}>Start ₹99/month</a></div>
